...
* [Download and save the files](https://cf-my.sharepoint.com/:f:/g/personal/harveyae\_cardiff\_ac\_uk/ElHUwDRioyBPnjviUpeuYk8Bf0mYZLVsKeMwEivW78z\_zw?e=ZyWqbw) you'll use to create the sample site. There are 30 jpg images and 1 csv metadata file. You won't need to open or edit the csv file during this workshop, but if you do want to take a look, make sure to open the file using Google Sheets rather than Excel. Excel can introduce encoding that could later prevent the file from working properly. Below is a preview of the metadata file, for information.

<div data-full-width="true">

<figure><img src="../../.gitbook/assets/metadata.jpg" alt=""><figcaption><p>The metadata file contains everything the site needs to know about presenting and describing your images.</p></figcaption></figure>
